...
/*******************************************************
*                 EPD — EL097R2CRN 9.7" BWR
*
*  Stock-firmware reverse engineering confirms the same pinout as the
*  existing ELO58R2CRN board support.  Bring-up keeps software SPI.
*  EPD_BS must be LOW (SPI mode); EPD_PWR HIGH enables the panel rail.
*******************************************************/
