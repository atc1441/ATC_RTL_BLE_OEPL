...
/** @defgroup RSCS_Data_Length RSC Data Length
  * @brief  Max octets of RSC Measurement data and RSC Control Point data
  * @{
  */
...
/** @defgroup RSCS_Measurement_Data RSC Measurement Data
  * @brief  RSC measurement data, variable length during connection, max can reach 10 octets
  * @{
  */
typedef struct
{
...
/** @defgroup RSCS_Control_Point_Data RSC Control Point Data
  * @brief  RSC Control Point data, variable length during connection, max can reach 18 octets
  * @{
  */
typedef struct
{
