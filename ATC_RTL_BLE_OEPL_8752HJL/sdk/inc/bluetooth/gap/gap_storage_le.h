 ...
 * @param[in,out] p_data Pointer to local device name.
 * @return Operation result.
 * @retval 0 Operation success.
 * @retval Others Operation failure.
 *
 ...
 * @param[in] p_data Pointer to local appearance.
 * @return Operation result.
 * @retval 0 Operation success.
 * @retval Others Operation failure.
 *
 ...
 * @param[in,out] p_data Pointer to local appearance.
 * @return Operation result.
 * @retval 0 Operation success.
 * @retval Others Operation failure.
 *
 ...
 * @param[in] p_data Pointer to local IRK.
 * @return Operation result.
 * @retval 0 Operation success.
 * @retval Others Operation failure.
 *
 ...
 * @param[in,out] p_data Pointer to local IRK.
 * @return Operation result.
 * @retval 0 Operation success.
 * @retval Others Operation failure.
 *
 ...
 * @note This function cannot be used if local device uses different local
 *               addresses to bond with the same remote device. In this situation,
 *               @ref le_gen_bond_dev_v2 shall be called.
 *
 * @param[in] bd_addr        Remote Bluetooth device address.
 * @param[in] bd_type        Remote Bluetooth device address type.
 * @param[in] local_bd_type  Local Bluetooth device address type.
 ...
 * @return Pointer to the key entry.
 ...
 *
 * @param[in] handle_num     Number of attribute handles of CCCD which will not be erased.
 * @param[in] p_handle       Pointer to the attribute handle of CCCD which will not be erased.
 * @return Operation result.
 * @retval true     Operation success.
 * @retval false    Operation failure.
 */
