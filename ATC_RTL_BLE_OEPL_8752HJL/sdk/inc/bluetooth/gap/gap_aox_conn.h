 ...
 *          Result will be returned by the callback function with msg type @ref GAP_MSG_LE_AOX_SET_CONN_CTE_RECEIVE_PARAMS.
 *
 ...
 *          Result will be returned by the callback function with msg type @ref GAP_MSG_LE_AOX_SET_CONN_CTE_TRANSMIT_PARAMS.
 *
 * @param[in] conn_id  Connection ID.
 ...
 *          Result will be returned by the callback function with msg type @ref GAP_MSG_LE_AOX_CONN_CTE_REQUEST_ENABLE.
 *
 * IQ samples will be returned by the callback function with msg type @ref GAP_MSG_LE_AOX_CONN_IQ_REPORT_INFO
 *          on Constant Tone Extensions received.
 *          Otherwise, request failed info will be returned by the callback function with msg type
 ...
 *          Result will be returned by the callback function with msg type @ref GAP_MSG_LE_AOX_CONN_CTE_RESPONSE_ENABLE.
 *
 * @param[in] conn_id  Connection ID.
