...
#define GAP_MSG_VENDOR_EVT_INFO         0x04 //!< Vendor event type for gap_vendor_cmd_req.
/**
  * @}
  */
...
typedef union
{
    ...
    T_GAP_VENDOR_CMD_RSP         *p_gap_vendor_cmd_rsp;//!< Vendor command response.
    T_GAP_VENDOR_EVT_INFO        *p_gap_vendor_evt_info;//!< Vendor event information.
} T_GAP_CB_DATA;
...
/**
  ...
  *         GAP Parameter.  GAP Parameters are defined in @ref T_GAP_PARAM_TYPE.
