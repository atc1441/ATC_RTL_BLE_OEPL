 ...
 *              the callback function with msg type @ref GAP_MSG_LE_AOX_CONNLESS_RECEIVER_SET_IQ_SAMPLING_ENABLE.
 *
 * IQ information from the Constant Tone Extension of a received advertising packet forming part of
 *              the periodic advertising train will be reported by the callback function with msg type
