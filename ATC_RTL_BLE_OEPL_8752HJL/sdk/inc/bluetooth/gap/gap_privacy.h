...
/**
  ...
  * @param[in] peer_irk              Pointer to peer IRK (16 octets).
                                     @arg NULL: no peer IRK, use all-zero IRK.
  * @param[in] use_local_irk         Indicates whether local IRK has been distributed to the peer device.
                                     @arg False: local IRK has not been distributed to the peer device
                                     @arg True: local IRK has been distributed to the peer device.
  * @return Operation result.
  * @retval GAP_CAUSE_SUCCESS Operation success.
  * @retval Others Operation failure.
  */
