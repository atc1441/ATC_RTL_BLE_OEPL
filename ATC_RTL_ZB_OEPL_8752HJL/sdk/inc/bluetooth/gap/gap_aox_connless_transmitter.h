 ...
 *
 * If sending request operation is successful, the result of setting parameters related parameters will be returned by the callback
 * function with msg type @ref GAP_MSG_LE_AOX_CONNLESS_TRANSMITTER_SET_CTE_TRANSMIT_PARAMS.
 *
 ...
 * the callback function with msg type @ref GAP_MSG_LE_AOX_CONNLESS_TRANSMITTER_STATE_CHANGE_INFO.
 *
