...
/**
 * @brief   Start a device discovery scan. If device changes to scanning state, APP processing function
 *          will be called. And the advertising data or scan response data will be returned by the callback function
 *          with msg type @ref GAP_MSG_LE_SCAN_INFO.
 *
