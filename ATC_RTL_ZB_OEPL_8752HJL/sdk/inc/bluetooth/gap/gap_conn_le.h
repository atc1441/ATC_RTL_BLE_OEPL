...
typedef enum
{
    GAP_PARAM_CONN_BD_ADDR         = 0x270,//!< Address of connected device. Read only. Size is 6 octets. Set to all zeros when not connected.
    GAP_PARAM_CONN_BD_ADDR_TYPE    = 0x271,//!< Address type of connected device. Read only. Size is 1 octet. Set to zero when not connected.
    GAP_PARAM_CONN_INTERVAL        = 0x272,//!< Current connection interval. Read only. Size is 2 octets. Range is 7.5ms to 4 seconds (0x0006 to 0x0C80). Default is 0 (no connection).
    GAP_PARAM_CONN_LATENCY         = 0x273,//!< Current slave latency. Read only. Size is 2 octets. Range is 0 to 499. Default is 0 (no slave latency or no connection).
    GAP_PARAM_CONN_TIMEOUT         = 0x274,//!< Current timeout value. Read only. Size is 2 octets. Range is 100ms to 32 seconds. Default is 0 (no connection).
    GAP_PARAM_CONN_MTU_SIZE        = 0x275,//!< MTU size. Read only. Size is 2 octets.
    GAP_PARAM_CONN_LOCAL_BD_TYPE   = 0x276,//!< Local Bluetooth address type. Read only. Size is 1 octet.
    GAP_PARAM_CONN_RX_PHY_TYPE     = 0x277,//!< Rx phy type. Read only. Size is 1 octet.
    GAP_PARAM_CONN_TX_PHY_TYPE     = 0x278,//!< Tx phy type. Read only. Size is 1 octet.
    GAP_PARAM_CONN_REMOTE_FEATURES = 0x279,//!< Remote supported features. Read only. Size is @ref GAP_LE_SUPPORTED_FEATURES_LEN
...
/**
  ...
  *         GAP connection parameter. GAP connection parameters are defined in @ref T_LE_CONN_PARAM_TYPE.
  *         The "p_value" field must point to an appropriate data type matches the parameter type.
  *
...
/**
 * @brief   Terminates the existing connection. When link is disconnected, APP processing function will be
...
/**
 * @brief   Terminates the existing connection with reason. When link is disconnected, APP processing function will be
 *          called with new_state as @ref GAP_CONN_STATE_DISCONNECTED.
 *
 * @param[in] conn_id Connection ID to be disconnected.
 ...
 *          Remote version information will be returned by the callback function with msg type @ref GAP_MSG_LE_READ_REMOTE_VERSION.
 *
 * @param[in] conn_id Connection ID.
 ...
 *          the callback function with msg type @ref GAP_MSG_LE_READ_RSSI.
 *
 * @param[in] conn_id Connection ID.
 * @return  Read request result.
...
/**
  ...
  *          the callback function with msg type @ref GAP_MSG_LE_READ_CHANN_MAP.
  *
  * @param[in] conn_id Connection ID.
  * @return  Read request result.
...
/**
  ...
  *          the callback function with msg type @ref GAP_MSG_LE_SET_DATA_LEN. And if data length was changed,
  *          the callback function with msg type @ref GAP_MSG_LE_DATA_LEN_CHANGE_INFO will be called.
  *
  * @param[in] conn_id Connection ID.
...
/**
  ...
  *          If the phy used was changed, the callback function with msg type @ref GAP_MSG_LE_PHY_UPDATE_INFO will be called.
  *
  * @param[in] conn_id Connection ID.
...
/**
  ...
  *          the callback function with msg type @ref GAP_MSG_LE_DISABLE_SLAVE_LATENCY.
  *
...
/**
  ...
  *         the callback function with msg type @ref GAP_MSG_LE_UPDATE_PASSED_CHANN_MAP.
  *
...
/**
  ...
  *
  * @note The following tx power table may be changed in future version.
  *
  * @param[in] conn_id  Connection ID for this link.
