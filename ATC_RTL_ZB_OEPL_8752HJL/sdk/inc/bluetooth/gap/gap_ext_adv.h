 ...
 * @retval GAP_CAUSE_INVALID_PARAM Operation failure, the length of advertising data exceeds
                                   1024 octets(Maximum total length of GAP extended advertising data).
 *
 * <b>Example usage</b>
 * \code{.c}
 ...
 * @brief       Set extended advertising parameters for an advertising set.
                ...
                the callback function with msg type @ref GAP_MSG_LE_EXT_ADV_START_SETTING.
 *
 * @param[in]   adv_handle     Identify an advertising set, which is assigned by @ref le_ext_adv_create_adv_handle.
 ...
 * @brief       Enable extended advertising for one or more advertising sets.
                If the device changes to an advertising state, APP processing function will be called, and
                the callback function with msg type @ref GAP_MSG_LE_EXT_ADV_ENABLE will be called.
 *
 ...
 * @brief       Disable extended advertising for one or more advertising sets.
                If device changes to idle state, APP processing function will be called, and
                the callback function with msg type @ref GAP_MSG_LE_EXT_ADV_DISABLE will be called.
 *
 * @param[in]   num_of_sets      Number of advertising sets to enable.
 * @param[in]   adv_handle       Pointer to advertising set to enable.
 *
 ...
 * @brief       Remove all existing advertising sets.
                ...
                the callback function with msg type @ref GAP_MSG_LE_EXT_ADV_CLEAR_SET.
 *
 * @return Operation result.
 ...
 * @brief       Remove an advertising set.
                ...
                the callback function with msg type @ref GAP_MSG_LE_EXT_ADV_REMOVE_SET.
 *
...
*         If use_msg is False, GAP will send the extended advertising GAP message using callback function
*         registered by APP. Message type is @ref GAP_MSG_LE_EXT_ADV_STATE_CHANGE_INFO.
*
