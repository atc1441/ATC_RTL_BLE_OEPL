...
/** @brief  Max octets of CSC Measurement data. */
#define CSCS_MAX_MEASUREMENT_VALUE           11
/** @brief  Max octets of CSC Control Point data. */
...
/** @brief CSC measurement data, variable length during connection, max can reach 11 octets */
typedef struct
{
...
/**
 * @brief CSC Control Point data, variable length during connection, max can reach 17 octets.
 *
