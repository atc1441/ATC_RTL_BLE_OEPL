                ...
                case 0x00:
                ...
                } case 0x04:
                    {
                        ...
                        if (HCIlen > 1)
                        {
                            ...
                            HCICommand_Params_struct[5] = HCIlen - 13;
                        }
                        for (int i = 0; i < strlen(a); i++)
                        {
                            line_add_char(pshell_cmd, a[i]);
                ...
                } case 0x0d:
                    {
                        ...
                        if (HCIlen > 1)
                        {
                            ...
                            HCICommand_Params_struct[3] = 4;
                            HCICommand_Params_struct[4] = 4;
                            HCICommand_Params_struct[5] = HCIlen - 25;
                        }
                        for (int i = 0; i < strlen(a); i++)
                        {
                            line_add_char(pshell_cmd, a[i]);
                    ...
                    {
                        char a[] = "encdata"; //HCI command parameter: encdata
                        HCICommand_Params_struct[0] = HCIlen;
                        if (HCIlen > 1)
                        {
                            ...
                            HCICommand_Params_struct[2] = 16;
                            HCICommand_Params_struct[3] = 4;
                            HCICommand_Params_struct[4] = 2;
                            HCICommand_Params_struct[5] = 2;
                            HCICommand_Params_struct[6] = HCIlen - 25;
                        }
                        for (int i = 0; i < strlen(a); i++)
                        {
                            line_add_char(pshell_cmd, a[i]);
                    ...
                    {
                        char a[] = "ifconfig r"; //HCI command parameter: rxfiltermon
                        HCICommand_Params_struct[0] = HCIlen;
                        if (HCIlen > 1)
                        {
                            HCICommand_Params_struct[1] = 0;
                    ...
                    {
                        char a[] = "raw"; //HCI command parameter: mackey
                        HCICommand_Params_struct[0] = HCIlen;
                        if (HCIlen > 1)
                        {
                            HCICommand_Params_struct[1] = HCIlen / 2 + 1;
                            for (int i = 2; i < HCIlen / 2 + 1; i++)
                            {
                    ...
                    {
                        char a[] = "ctx"; //HCI command parameter: ctx
                        HCICommand_Params_struct[0] = HCIlen;
                        if (HCIlen > 1)
                        {
                            HCICommand_Params_struct[1] = 1;
