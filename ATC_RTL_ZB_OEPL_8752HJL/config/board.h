...
*******************************************************/
#define NFC_PWR_PIN     P5_1    /* GPIO18 — Power enable: HIGH = on        */
#define NFC_SDA_PIN     P2_3    /* GPIO20 — I2C SDA (open-drain)           */
#define NFC_SCL_PIN     P2_4    /* GPIO21 — I2C SCL (open-drain)           */
#define NFC_FIELD_PIN   P2_2    /* pad 38  — RF field detect (AON GPIO)    */
...
*******************************************************/
#define EXT_FLASH_CS_PIN    P4_2
#define EXT_FLASH_CLK_PIN   P4_0
#define EXT_FLASH_MOSI_PIN  P4_1
#define EXT_FLASH_MISO_PIN  P4_3

#define LED_R P2_5
#define LED_G P2_6
#define LED_B P2_7

/* OEPL hardware type reported to the AP in AvailDataReq */
#define HW_TYPE  0x53
