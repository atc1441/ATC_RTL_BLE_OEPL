...
void eepromReadUID(uint8_t *dst) {
    SPI_Flash_CS_set(0);
    SPI_Flash_transceive(0x4b);   /* Read Unique ID */
    SPI_Flash_transceive(0x00);   /* 4 dummy bytes */
    SPI_Flash_transceive(0x00);
    SPI_Flash_transceive(0x00);
    SPI_Flash_transceive(0x00);
 ...
 * Image area ends at slot 4: 5 × 0x17000 = 0x4B800 — well below 0x7F000.
 *
