...
#define GATT_SVC_HID_REPORT_KEYBOARD_INPUT_INDEX        (4)
#define GATT_SVC_HID_REPORT_KEYBOARD_INPUT_CCCD_INDEX   (GATT_SVC_HID_REPORT_KEYBOARD_INPUT_INDEX+1)
#define GATT_SVC_HID_REPORT_OUTPUT_INDEX                (8)
#define GATT_SVC_HID_REPORT_CONSUMER_INPUT_INDEX        (11)
#define GATT_SVC_HID_REPORT_CONSUMER_INPUT_CCCD_INDEX   (GATT_SVC_HID_REPORT_CONSUMER_INPUT_INDEX+1)
