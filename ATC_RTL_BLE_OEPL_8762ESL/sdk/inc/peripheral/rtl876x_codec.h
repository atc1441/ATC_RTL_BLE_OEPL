...
#define SAMPLE_RATE_44_1KHz                 ((uint32_t)(0x08 << CODEC_SAMPLE_RATE_POS))
/** \} */

#define IS_SAMPLE_RATE(RATE) (((RATE) == SAMPLE_RATE_16KHz) || \
                              ((RATE)  == SAMPLE_RATE_8KHz)  || \
                              ((RATE)  == SAMPLE_RATE_32KHz) || \
                              ((RATE)  == SAMPLE_RATE_48KHz) || \
                              ((RATE)  == SAMPLE_RATE_44_1KHz)))
