...
/** @defgroup AON_WATCH_DOG_Exported_Types Watch Dog Exported Types
  * @{
  */
typedef enum
{
    AON_WDT_RESET_ALL_EXCEPT_AON = 0,
    AON_WDT_RESET_ALL = 1
} T_AON_WDG_MODE;
...
/**
   ...
   * @retval none.
   */
void AON_WDG_Config(T_AON_WDG_MODE reset_level, uint32_t comp, uint8_t cnt_ctl, uint8_t cnt_reload);
...
/**
   ...
   */
static inline void aon_wdg_init(T_AON_WDG_MODE reset_level, uint8_t timeout_second)
{
