...
#define HOGP_KEYBOARD_REPORT_ID                     0x01
#define HOGP_CONSUMER_REPORT_ID                     0x03
...
// keyboard data format(full key unshocked)
...
//3           0x0C ~ 0x13     (I & i) ~ (P & p)
//
//14          0x64 ~ 0x6B     (Keyboard Non-US ) ~ (Keyboard F16)
const uint8_t hids_report_descriptor[] =
{
#if FEATURE_SUPPORT_FULL_KEY_UNSHOCKED
    /* REPORT_ID        (1) */
    /*USAGE_PAGE       (Generic Desktop)*/
    0x05, 0x01,                    // USAGE_PAGE (Generic Desktop)
    0x09, 0x06,                    // USAGE (Keyboard)
    0xa1, 0x01,                    // COLLECTION (Application)
    0x85, HOGP_KEYBOARD_REPORT_ID, /* REPORT_ID        (1) */
    ...
    0x29, 0x6A,                    //   USAGE_MAXIMUM (Keyboard Application)
    0x15, 0x00,                    //   LOGICAL_MINIMUM (0)
    0x25, 0x01,                    //   LOGICAL_MAXIMUM (1)
    0x95, 0x67,                    //   REPORT_COUNT (103)
    0x75, 0x01,                    //   REPORT_SIZE (1)
    0x81, 0x02,                    //   INPUT (Data,Var,Abs)
    0x95, 0x01,                    //   REPORT_COUNT (1)
    0x75, 0x01,                    //   REPORT_SIZE (1)
...
//    0x81, 0x03,     /*input (cons,variable,Abs)*/
    ...
    0xa1, 0x01,     /* COLLECTION       (Application) */
    0x85, HOGP_CONSUMER_REPORT_ID,     /* REPORT_ID        (3) */
    0x15, 0x00,     /* LOGICAL_MINIMUM  (0) */
...
static const T_ATTRIB_APPL hids_attr_tbl[] =
{
    ...
    /*  HID comsumer Report characteristic value .. 11*/
    {
        ATTRIB_FLAG_VALUE_APPL,                   /* wFlags */
        {                                         /* bTypeValue */
            LO_WORD(GATT_UUID_CHAR_REPORT),
...
void hids_cccd_update_cb(uint8_t conn_id, T_SERVER_ID service_id, uint16_t index, uint16_t ccc_bits)
{
    ...
    case GATT_SVC_HID_REPORT_KEYBOARD_INPUT_CCCD_INDEX:
        {
            callback_data.msg_data.not_ind_data.index = GATT_SVC_HID_REPORT_KEYBOARD_INPUT_CCCD_INDEX;
    ...
    case GATT_SVC_HID_REPORT_CONSUMER_INPUT_CCCD_INDEX:
        {
