...
/*******************************************************************************************************/
#if USE_CTC_DLPS
__STATIC_INLINE void CAPTOUCH_DLPS_Enter(void);
__STATIC_INLINE void CAPTOUCH_DLPS_Exit(void);

/**
  * @brief  CAPTOUCH enter dlps callback function(Save CAPTOUCH register values when system enter DLPS)
  * @param  None
  * @retval None
  */
__STATIC_INLINE void CAPTOUCH_DLPS_Enter(void) DATA_RAM_FUNCTION;
void CAPTOUCH_DLPS_Enter(void)
{
    return;
}

/**
  * @brief  CAPTOUCH exit dlps callback function(Resume CAPTOUCH register values when system exit DLPS)
  * @param  None
  * @retval None
  */
__STATIC_INLINE void CAPTOUCH_DLPS_Exit(void) DATA_RAM_FUNCTION;
void CAPTOUCH_DLPS_Exit(void)
{
    (*((volatile uint32_t *)0x40000234UL)) |= BIT12;
    return;
}
